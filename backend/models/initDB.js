...
sequelize.sync({force: true}).then(async () => {
    const Admin = await sequelize.models.User.create({firstName: 'admin', lastName: 'admin', email:'admin@admin.com', password:'admin', createdAt: new Date(), updatedAt: new Date()})
    const User = await sequelize.models.User.create({firstName: 'user', lastName: 'user', email:'user@user.com', password:'user', createdAt: new Date(), updatedAt: new Date()})
    const User2 = await sequelize.models.User.create({firstName: 'user2', lastName: 'user2', email:'user2@user2.com', password:'user2', createdAt: new Date(), updatedAt: new Date()})
